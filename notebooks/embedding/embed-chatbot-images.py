...
# %%
model = prediction.Pipeline(config, storage_path, False)
model.net

# %% [markdown]
### Extract features and save to storage, save images to directory
...
# %%
io.save_pickle(apparel_feature_vecs, new_storage_path)
new_hashes_polyvore = io.load_pickle(new_storage_path)
len(new_hashes_polyvore)
